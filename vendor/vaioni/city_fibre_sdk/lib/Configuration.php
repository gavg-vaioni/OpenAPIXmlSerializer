...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-gw.cityfibre.com:41223/prod/api2';
    ...
    {
        $report  = 'PHP SDK (Vaioni\CityFibreAPI) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api-gw.cityfibre.com:41223/prod/api2",
                "description" => "Main (production) server",
            ],
            [
                "url" => "https://api-gw.cityfibre.com:41223/cfstaging/api2",
                "description" => "CFStaging server",
            ],
            [
                "url" => "https://api-gw.cityfibre.com:41223/cfsit/api2",
                "description" => "CFSit server",
            ]
        ];
    }
