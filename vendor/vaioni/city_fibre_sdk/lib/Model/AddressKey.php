 ...
 */
class AddressKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Address_Key';
    ...
    */
    ...
    public function setAddressKey($address_key)
    {
        if ((mb_strlen($address_key) > 63)) {
            throw new \InvalidArgumentException('invalid length for $address_key when calling AddressKey., must be smaller than or equal to 63.');
        }
