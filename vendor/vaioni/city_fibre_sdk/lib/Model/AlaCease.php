 ...
 */
class AlaCease implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'alaCease';
    ...
    */
    ...
    public function setServiceIdentifier($service_identifier)
    {
        if ((mb_strlen($service_identifier) > 36)) {
            throw new \InvalidArgumentException('invalid length for $service_identifier when calling AlaCease., must be smaller than or equal to 36.');
        }
