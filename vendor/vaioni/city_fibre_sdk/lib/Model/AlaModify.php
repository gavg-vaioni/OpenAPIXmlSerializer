 ...
 */
class AlaModify implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'alaModify';
    ...
    */
    ...
    public function setServiceIdentifier($service_identifier)
    {
        if (!is_null($service_identifier) && (mb_strlen($service_identifier) > 36)) {
            throw new \InvalidArgumentException('invalid length for $service_identifier when calling AlaModify., must be smaller than or equal to 36.');
        }
