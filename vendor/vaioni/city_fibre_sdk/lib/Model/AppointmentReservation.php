...
/**
 * AppointmentReservation Class Doc Comment
 *
 * @category Class
 * @package  Vaioni\CityFibreAPI
 * @author   OpenAPI Generator team
 ...
 */
class AppointmentReservation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'appointmentReservation';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['appointment_reservation_key']) && (mb_strlen($this->container['appointment_reservation_key']) > 36)) {
     ...
     *
     * @param mixed|null $appointment_reservation_key The unique key for appointment reservation
     *
     * @return self
     */
    public function setAppointmentReservationKey($appointment_reservation_key)
    {
        if (!is_null($appointment_reservation_key) && (mb_strlen($appointment_reservation_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $appointment_reservation_key when calling AppointmentReservation., must be smaller than or equal to 36.');
        }
