 ...
 *
 * @category Class
 * @description Represents the appointment slot details (date, start time, end time)
 * @package  Vaioni\CityFibreAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setAppointmentDate($appointment_date)
    {
        ...
        if ((!preg_match("^[0-9]{4}-[0-9]{2}-[0-9]{2}.*$", $appointment_date))) {
            throw new \InvalidArgumentException("invalid value for \$appointment_date when calling AppointmentSlot., must conform to the pattern ^[0-9]{4}-[0-9]{2}-[0-9]{2}.*$.");
        }
    ...
    public function setAppointmentStartTime($appointment_start_time)
    {
        if ((mb_strlen($appointment_start_time) > 5)) {
            throw new \InvalidArgumentException('invalid length for $appointment_start_time when calling AppointmentSlot., must be smaller than or equal to 5.');
        }
    ...
    public function setAppointmentEndTime($appointment_end_time)
    {
        if ((mb_strlen($appointment_end_time) > 5)) {
            throw new \InvalidArgumentException('invalid length for $appointment_end_time when calling AppointmentSlot., must be smaller than or equal to 5.');
        }
