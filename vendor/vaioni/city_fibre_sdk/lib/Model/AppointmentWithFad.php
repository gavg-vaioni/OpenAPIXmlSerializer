...
/**
 * AppointmentWithFad Class Doc Comment
 *
 * @category Class
 * @package  Vaioni\CityFibreAPI
 * @author   OpenAPI Generator team
 ...
 */
class AppointmentWithFad implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'appointmentWithFad';
    ...
    protected static $openAPIFormats = [
        ...
        'cfhfirst_available_date' => 'date-time'
    ];
    ...
    protected static $attributeMap = [
        ...
        'cfhfirst_available_date' => 'cfh:firstAvailableDate'
    ];
    ...
    protected static $setters = [
        ...
        'cfhfirst_available_date' => 'setCfhfirstAvailableDate'
    ];
    ...
    protected static $getters = [
        ...
        'cfhfirst_available_date' => 'getCfhfirstAvailableDate'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cfhfirst_available_date', $data ?? [], null);
    }
    ...
    */
    ...
    public function setAppointmentDate($appointment_date)
    {
        ...
        if ((!preg_match("^[0-9]{4}-[0-9]{2}-[0-9]{2}.*$", $appointment_date))) {
            throw new \InvalidArgumentException("invalid value for \$appointment_date when calling AppointmentWithFad., must conform to the pattern ^[0-9]{4}-[0-9]{2}-[0-9]{2}.*$.");
        }
    ...
    public function setAppointmentStartTime($appointment_start_time)
    {
        if ((mb_strlen($appointment_start_time) > 5)) {
            throw new \InvalidArgumentException('invalid length for $appointment_start_time when calling AppointmentWithFad., must be smaller than or equal to 5.');
        }
    ...
    public function setAppointmentEndTime($appointment_end_time)
    {
        if ((mb_strlen($appointment_end_time) > 5)) {
            throw new \InvalidArgumentException('invalid length for $appointment_end_time when calling AppointmentWithFad., must be smaller than or equal to 5.');
        }
    ...
    public function setAppointmentReservationKey($appointment_reservation_key)
    {
        if ((mb_strlen($appointment_reservation_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $appointment_reservation_key when calling AppointmentWithFad., must be smaller than or equal to 36.');
        }
    ...
    /**
     * Gets cfhfirst_available_date
     *
     * @return mixed|null
     */
    public function getCfhfirstAvailableDate()
    {
        return $this->container['cfhfirst_available_date'];
    }

    /**
     * Sets cfhfirst_available_date
     *
     * @param mixed|null $cfhfirst_available_date First available date
     *
     * @return self
     */
    public function setCfhfirstAvailableDate($cfhfirst_available_date)
    {

        if (is_null($cfhfirst_available_date)) {
            array_push($this->openAPINullablesSetToNull, 'cfhfirst_available_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cfhfirst_available_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['cfhfirst_available_date'] = $cfhfirst_available_date;
