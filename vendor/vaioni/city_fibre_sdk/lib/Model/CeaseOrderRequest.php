...
/**
 * CeaseOrderRequest Class Doc Comment
 *
 * @category Class
 * @description To make a new cease order.
 * @package  Vaioni\CityFibreAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CeaseOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ceaseOrderRequest';
    ...
    protected static $openAPITypes = [
        ...
        'ala_cease' => '\Vaioni\CityFibreAPI\Model\AlaCease'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ala_cease', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ala_cease'] === null) {
            $invalidProperties[] = "'ala_cease' can't be null";
        }
     ...
     * Gets ala_cease
     *
     * @return \Vaioni\CityFibreAPI\Model\AlaCease
     */
    public function getAlaCease()
    {
        return $this->container['ala_cease'];
    }

    /**
     * Sets ala_cease
     *
     * @param \Vaioni\CityFibreAPI\Model\AlaCease $ala_cease ala_cease
     *
     * @return self
     */
    public function setAlaCease($ala_cease)
    {

        if (is_null($ala_cease)) {
            throw new \InvalidArgumentException('non-nullable ala_cease cannot be null');
        }

        $this->container['ala_cease'] = $ala_cease;
