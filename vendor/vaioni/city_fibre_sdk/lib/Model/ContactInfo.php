 ...
 *
 * @category Class
 * @description Buyer contact info
 * @package  Vaioni\CityFibreAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ContactInfo., must be smaller than or equal to 254.');
        }
     ...
     *
     * @param mixed|null $telephone_number telephone_number
     *
     * @return self
     */
    public function setTelephoneNumber($telephone_number)
    {
        if (!is_null($telephone_number) && (mb_strlen($telephone_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $telephone_number when calling ContactInfo., must be smaller than or equal to 50.');
        }
