...
/**
 * InstallOrderRequest Class Doc Comment
 *
 * @category Class
 * @description To make a new order. The buyer should send a request containing information about himself (name, phone, email etc.), product (product name, line profile etc.), location (UPRN, hazards, access restrictions etc.) and so on.
 * @package  Vaioni\CityFibreAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InstallOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'installOrderRequest';
    ...
    protected static $openAPITypes = [
        ...
        'order_references' => '\Vaioni\CityFibreAPI\Model\NewOrderReferences',
        'buyer' => '\Vaioni\CityFibreAPI\Model\Buyer',
        'seller' => '\Vaioni\CityFibreAPI\Model\Seller',
        'ala_new_install' => 'mixed'
    ];
    ...
    protected static $setters = [
        ...
        'buyer' => 'setBuyer',
        'seller' => 'setSeller',
        'ala_new_install' => 'setAlaNewInstall'
    ];
    ...
    protected static $getters = [
        ...
        'buyer' => 'getBuyer',
        'seller' => 'getSeller',
        'ala_new_install' => 'getAlaNewInstall'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ala_new_install', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ala_new_install'] === null) {
            $invalidProperties[] = "'ala_new_install' can't be null";
        }
     ...
     *
     * @return \Vaioni\CityFibreAPI\Model\NewOrderReferences
     */
     ...
     *
     * @param \Vaioni\CityFibreAPI\Model\NewOrderReferences $order_references order_references
     *
     * @return self
     */
    ...
    /**
     * Gets ala_new_install
     *
     * @return mixed
     */
    public function getAlaNewInstall()
    {
        return $this->container['ala_new_install'];
    }

    /**
     * Sets ala_new_install
     *
     * @param mixed $ala_new_install ala_new_install
     *
     * @return self
     */
    public function setAlaNewInstall($ala_new_install)
    {

        if (is_null($ala_new_install)) {
            array_push($this->openAPINullablesSetToNull, 'ala_new_install');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ala_new_install', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['ala_new_install'] = $ala_new_install;
