...
/**
 * OrderLocation Class Doc Comment
 *
 * @category Class
 * @package  Vaioni\CityFibreAPI
 * @author   OpenAPI Generator team
 ...
 */
class OrderLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orderLocation';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['address_key']) && (mb_strlen($this->container['address_key']) > 63)) {
     ...
     * Sets address_key
     *
     * @param mixed|null $address_key Unique identifier of the address (UPRN)
     *
     * @return self
     */
    public function setAddressKey($address_key)
    {
        if (!is_null($address_key) && (mb_strlen($address_key) > 63)) {
            throw new \InvalidArgumentException('invalid length for $address_key when calling OrderLocation., must be smaller than or equal to 63.');
        }
