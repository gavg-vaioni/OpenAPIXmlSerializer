 ...
 *
 * @category Class
 * @description the Active Network Operator who provides the service is the seller
 * @package  Vaioni\CityFibreAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Seller implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['seller_identifier'] === null) {
            $invalidProperties[] = "'seller_identifier' can't be null";
        }
        if ((mb_strlen($this->container['seller_identifier']) > 36)) {
            $invalidProperties[] = "invalid value for 'seller_identifier', the character length must be smaller than or equal to 36.";
        }
     ...
     *
     * @param mixed $seller_identifier Unique identifier of the seller
     *
     * @return self
     */
    public function setSellerIdentifier($seller_identifier)
    {
        if ((mb_strlen($seller_identifier) > 36)) {
            throw new \InvalidArgumentException('invalid length for $seller_identifier when calling Seller., must be smaller than or equal to 36.');
        }


        if (is_null($seller_identifier)) {
            array_push($this->openAPINullablesSetToNull, 'seller_identifier');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('seller_identifier', $nullablesSetToNull);
            if ($index !== FALSE) {
